...
dt = pd.date_range(start="10/27/2020", end='10/28/2024', freq='B')
for tday in dt:
    try:
        ...
        result.to_csv('E:\\software\\Devinderjeet\\trading\\amibroker\\datafeed\\NSE\\' + filename, header =False,index = False )
